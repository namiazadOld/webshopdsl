...
public class WebShopDSLParseController extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("WebShopDSL");
  ...
  { 
    try
    { 
      InputStream descriptorStream = WebShopDSLParseController.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = WebShopDSLParseController.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(WebShopDSLParseController.class);
    }
  ...
  { 
    return WebShopDSLParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
